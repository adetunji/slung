defmodule Slung.RoomController do
  use Slung.Web, :controller

  alias Slung.Room

  plug Guardian.Plug.EnsureAuthenticated, handler: Slung.SessionController
  ...
  def create(conn, params) do
    ...
    case Repo.insert(changeset) do
      {:ok, room} ->
        assoc_changeset = Slung.UserRoom.changeset(
          %Slung.UserRoom{},
  ...
  def join(conn, %{"id" => room_id}) do
    ...
    changeset = Slung.UserRoom.changeset(
      %Slung.UserRoom{},
